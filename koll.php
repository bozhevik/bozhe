...
<!-- Контент страницы "Отображение, поиск и изменение описания покупки" -->
<div class="container">

    <!-- Форма для поиска фокупкиа -->
    <form action="search.php" method="post">
        <div class="mb-3">
            <label for="search" class="form-label">Поиск по покупкам</label>
            <input type="text" name="search-tearm" class="form-control" id="search" placeholder="Введите название">
        </div>
        ...
        <div class="col-sm-6">
            <div class="post row1">
                ...
                <div class="col-12 col-md-8 post_text">
                    ...
                    <i class="s22" >Магазин: <?= $exhibit['place']?></i>
                    <i class="s22" >Цена: <?= $exhibit['age']?></i>
