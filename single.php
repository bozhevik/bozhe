...
<!-- Контент страницы "Отображение, поиск и изменение описания" -->
    ...
    <div class="content row">
        ...
        <div class="main-content col-md-9 col-12">
            ...
            <div class="single_post row">
                ...
                <div class="info">
                    <i class="s22"><strong>Магазин:</strong> <?php echo $exhibit['place'] ?></i>
                    <i class="s22"><strong>Цена:</strong> <?php echo $exhibit['age'] ?></i>
                    <i class="s22"><strong>Вид товара:</strong> <?php echo $exhibit['valuation'] ?></i>
                </div>
